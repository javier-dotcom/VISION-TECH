    ...
    <div class="login">
        ...
        <div class="todo">
            <div class="aside">
                ...
                <a href="">
                    <div class="inicio a"><svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-brand-gmail" width="46" height="46" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="#ffbf00" fill="none" stroke-linecap="round"
                            stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
echo "<h2 class='stock4'>El producto de codigo (" . $fila["Cod_producto"] . ") tipo (" . $fila["Tipo"] . ") marca ("  . $fila["Nombre"] . ") tiene un stock de : <span>( " . $fila["Stock"] . ") unidades</span></h2>";
